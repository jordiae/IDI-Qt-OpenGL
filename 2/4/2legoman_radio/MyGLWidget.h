...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  private:
    ...
    void capsa_contenidora_lego(glm::vec3 p_min, glm::vec3 p_max);

    double distancia_punts(glm::vec3 a, glm::vec3 b);

    void calcul_punts_capsa();

    void calcul_punts_capsa_lego();
    ...
    glm::vec3 centre_capsa_contenidora_lego;
    float radi_esfera_lego;

    glm::vec3 punt_min_lego;
    glm::vec3 punt_max_lego;
    ...
    enum Model_seleccionat {pat,lego};
    Model_seleccionat model_seleccionat;


public slots:
    void tractaCanviFOV(int x);
    void patricioClicat();
    void legomanClicat();
