...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(spinBox, SIGNAL(valueChanged(int)), widget, SLOT(tractaCanviFOV(int)));
        QObject::connect(radioButton, SIGNAL(clicked()), widget, SLOT(patricioClicat()));
        QObject::connect(radioButton_2, SIGNAL(clicked()), widget, SLOT(legomanClicat()));
